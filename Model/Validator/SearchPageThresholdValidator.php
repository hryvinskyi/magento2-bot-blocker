...
/**
 * Rate limiting validator for search result pages.
 */
class SearchPageThresholdValidator extends AbstractPageTypeThresholdValidator
{
    ...
    {
        return $this->config->isSearchPageRateLimitEnabled();
    }
    ...
    {
        return $this->config->getSearchPageThreshold();
    }
    ...
    {
        return $this->config->getSearchPageTimeframe();
    }
    ...
    {
        return $this->config->getSearchPageBlockTime();
    }
